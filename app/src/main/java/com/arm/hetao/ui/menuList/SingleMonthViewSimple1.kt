...
import com.sy007.calendar.isOverDue
 ...
 *    version: 1.0
 */
class SingleMonthViewSimple1 @JvmOverloads constructor(
    context: Context,
    ...
    private fun initDrawable() {
        selectedBgDrawable =
            ContextCompat.getDrawable(context, R.drawable.drawable_calendar_selected_bg)!!
    }
