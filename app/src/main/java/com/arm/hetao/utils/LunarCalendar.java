...
public final class LunarCalendar {
   ...
   */
  private static final int[] LUNAR_INFO = {0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950,
...
//2090-2099
  ...
  public static String getLunarText(int year, int month, int day) {
    ...
    if (year > MAX_YEAR || year == MAX_YEAR && ((month > MAX_MONTH) || (month <= MAX_MONTH
        && day > MAX_DAY))) {
      return "";
    }
